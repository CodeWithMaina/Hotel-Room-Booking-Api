...
export const getAmenityByIdService = async (amenityId: number): Promise<TAmenitySelect | null> => {
...
export const createAmenityService = async (amenityData: TAmenityInsert): Promise<TAmenitySelect> => {
...
export const deleteAmenityService = async (amenityId: number): Promise<TAmenitySelect | null> => {
